 ...
 * @property Post[] $posts
 * @property PostNotice[] $postNotices
...
class User extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(Notify::className(), ['fk_user' => 'id']);
    }
    ...
    {
        return $this->hasMany(Post::className(), ['fk_user' => 'id']);
    }

    /**
     * @return \yii\db\ActiveQuery
     */
    public function getPostNotices()
    {
        return $this->hasMany(PostNotice::className(), ['fk_user' => 'id']);
    }
